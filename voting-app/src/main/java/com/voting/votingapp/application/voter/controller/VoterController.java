...
public class VoterController {
  ...
  @PatchMapping
  @Operation(operationId = "setBlockage", description = "Allows admin to set user blockage")
  @ApiResponses({
  ...
  public ResponseEntity<Void> setBlockage(
      @RequestParam @NotBlank @NotEmpty String email, @RequestParam @NotNull Boolean blocked) {
